...
//HEADER BORDER COLOR
$wp_customize->add_setting( 'complete[head_border_color_id]', array(
	'type' => 'option',
	'default' => '#523d26',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'head_border_color_id', array(
				'label' => __('Header Border Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[head_border_color_id]',
			) ) );
...
$wp_customize->add_setting( 'complete[menu_border_color_active]', array(
	'type' => 'option',
	'default' => '#b58a52',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_border_color_active', array(
				'label' => __('Menu Active Border Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[menu_border_color_active]',
			) ) );
