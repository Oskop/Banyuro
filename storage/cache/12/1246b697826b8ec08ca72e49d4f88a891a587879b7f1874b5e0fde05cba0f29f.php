...
/* mintleaf/template/account/wishlist.twig */
class __TwigTemplate_e6104426b634b7d0ce2ff72a7522355a56538d3a7178c700d888c47751ed700c extends Twig_Template
{
        ...
        <table class=\"table table-bordered table-striped table-hover\">
          ...
          ";
            ...
            <td class=\"text-right\"><button type=\"button\" onclick=\"cart.add('";
                ...
                echo "\" class=\"btn btn-main\"><i class=\"fa fa-shopping-cart\"></i></button>
              <a href=\"";
                // line 50
                echo $this->getAttribute($context["product"], "remove", array());
                echo "\" data-toggle=\"tooltip\" title=\"";
                echo (isset($context["button_remove"]) ? $context["button_remove"] : null);
                echo "\" class=\"btn btn-main danger\"><i class=\"fa fa-times\"></i></a></td>
          </tr>
          ";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return "mintleaf/template/account/wishlist.twig";
    }
...
/*               {% endif %}</td>*/
/*             <td class="text-right"><button type="button" onclick="cart.add('{{ product.product_id }}');" data-toggle="tooltip" title="{{ button_cart }}" class="btn btn-main"><i class="fa fa-shopping-cart"></i></button>*/
/*               <a href="{{ product.remove }}" data-toggle="tooltip" title="{{ button_remove }}" class="btn btn-main danger"><i class="fa fa-times"></i></a></td>*/
/*           </tr>*/
/*           {% endfor %}*/
/*             </tbody>*/
/*           */
