...
function complete_option_defaults() {
	$defaults = array(
		...
		'totop_id' => '1',
		'footer_text_id' => __('&copy; Copyright 2018 Cafe. All Rights Reserved. Designed by SKT Themes', 'complete'),
        ...
        'slide_title1' => 'Black Coffee',
        'slide_desc1' => 'Fusce suscipit mauris quis convallis pharetra. Maecenas vitae elit <br> consectetur, dapibus augue eu.',
        'slide_link1' => '#link1',
        'slide_btn1' => 'Read More',
        
        'slide_image2' => ''.get_template_directory_uri().'/images/slides/slider2.jpg',
        'slide_title2' => 'Black Coffee',
        'slide_desc2' => 'Fusce suscipit mauris quis convallis pharetra. Maecenas vitae elit <br> consectetur, dapibus augue eu.',
        'slide_link2' => '#link2',
        'slide_btn2' => 'Read More',
        
        'slide_image3' => ''.get_template_directory_uri().'/images/slides/slider3.jpg',
        'slide_title3' => 'Black Coffee',
        'slide_desc3' => 'Fusce suscipit mauris quis convallis pharetra. Maecenas vitae elit <br> consectetur, dapibus augue eu.',
        'slide_link3' => '#link3',
		...
		'logo_image_id' => array(''),
		'logo_font_id' => array('font-family' => 'Pattaya', 'font-size' => '48px'),
		...
		'sldtitle_font_id' => array('font-family' => 'Pattaya', 'font-size' => '92px'),
		...
		'sldbtn_color_id' => '#906f44',
		'sldbtn_hvcolor_id' => '#b58a52',	
		
		'slide_pager_color_id' => '#ffffff',	
		'slide_active_pager_color_id' => '#b58a52',	
		
			
		'global_link_color_id' => '#b58a52',
		'global_link_hvcolor_id' => '#685031',		
		
		'global_h1_color_id' => '#282828',
		'global_h1_hvcolor_id' => '#b58a52',	
		'global_h2_color_id' => '#282828',
		'global_h2_hvcolor_id' => '#b58a52',
		'global_h3_color_id' => '#282828',
		'global_h3_hvcolor_id' => '#b58a52',
		'global_h4_color_id' => '#282828',
		'global_h4_hvcolor_id' => '#b58a52',
		'global_h5_color_id' => '#282828',
		'global_h5_hvcolor_id' => '#b58a52',
		'global_h6_color_id' => '#282828',
		'global_h6_hvcolor_id' => '#b58a52',	
		...
		'social_hover_icon_color_id' => '#b58a52',
		...
		'testimonial_activepager_color_id' => '#b58a52',
		'gallery_filter_color_id' => '#b58a52',
		...
		'global_h1_font_id' => array('font-family' => 'Marcellus', 'font-size' => '32px'),
		'global_h2_font_id' => array('font-family' => 'Marcellus', 'font-size' => '28px'),
		'global_h3_font_id' => array('font-family' => 'Marcellus', 'font-size' => '20px'),
		'global_h4_font_id' => array('font-family' => 'Marcellus', 'font-size' => '13px'),
		'global_h5_font_id' => array('font-family' => 'Marcellus', 'font-size' => '11px'),
		'global_h6_font_id' => array('font-family' => 'Marcellus', 'font-size' => '9px'),
		...
		'perfect_hover_border_color' => '#b58a52',
 
		'foot_layout_id' => '1',
		'footer_color_id' => '#1d1d1d',
		'footer_bg_image' => ''.get_template_directory_uri().'/images/footer-bg-img.jpg',
		'footwdgtxt_color_id' => '#fff',
		...
		'featured_block_hover_button_bg' => '#b58a52',
		...
		'foot_cols4_content' => '<form class="newsletter-form"><input placeholder="Enter your email" type="email"><i class="fa fa-paper-plane" aria-hidden="true"><input value="" type="submit"></i></form>[social_area][social icon="facebook" link="#"][social icon="google-plus" link="#"][social icon="twitter" link="#"][social icon="instagram" link="#"][/social_area]',
		//Footer Column 4																
