...
/* mintleaf/template/account/order_info.twig */
class __TwigTemplate_af5d6a1aa399633f3cab7b46d3247b6b9663963beac416e7615555145e7d8e3d extends Twig_Template
{
    ...
    ";
      ...
      <div class=\"table-responsive\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            if ($this->getAttribute($context["product"], "reorder", array())) {
                ...
                echo "\" class=\"btn btn-main\"><i class=\"fa fa-shopping-cart\"></i></a> ";
            }
            echo " <a href=\"";
            echo $this->getAttribute($context["product"], "return", array());
            echo "\" data-toggle=\"tooltip\" title=\"";
            echo (isset($context["button_return"]) ? $context["button_return"] : null);
            echo "\" class=\"btn btn-main danger\"><i class=\"fa fa-reply\"></i></a></td>
          </tr>
          ";
        }
        $_parent = $context['_parent'];
      ...
      ";
        ...
        if ((isset($context["histories"]) ? $context["histories"] : null)) {
            // line 131
            echo "      <br><h4 class=\"page-heading-1 alt\">";
...
";
    ...
    {
        return "mintleaf/template/account/order_info.twig";
    }
...
/*             <td class="text-right" style="white-space: nowrap;">{% if product.reorder %} <a href="{{ product.reorder }}" data-toggle="tooltip" title="{{ button_reorder }}" class="btn btn-main"><i class="fa fa-shopping-cart"></i></a> {% endif %} <a href="{{ product.return }}" data-toggle="tooltip" title="{{ button_return }}" class="btn btn-main danger"><i class="fa fa-reply"></i></a></td>*/
/*           </tr>*/
/*           {% endfor %}*/
...
/*       {% endif %}*/
/*       {% if histories %}*/
/*       <br><h4 class="page-heading-1 alt">{{ text_history }}</h4>*/
/*       <table class="table table-striped table-bordered table-hover">*/
/*         <thead>*/
/*           <tr>*/
...
/*         <div class="pull-right"><a href="{{ continue }}" class="btn btn-main">{{ button_continue }}</a></div>*/
/*       </div>*/
/*       {{ content_bottom }}</div>*/
/*     {{ column_right }}</div>*/
/* </div>*/
